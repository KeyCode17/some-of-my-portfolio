...
<h3 align="center">My technical assessment at some Companies <br> <strong>Don't worry i change it a bit so if the companies using same code to test someone, <br> the tester can't find it in google</strong></h3>
